...
public static class MeshGen {
    ...
    public static List<Vector3> RotateVertices(List<Vector3> vertices, float angle, Vector3 axis, Vector3 center) {
        ...
        return RotateVertices(vertices, rotation, center);
    }

    // return a copy of the specified vertices, rotated by the specified quaternion around the specified center
    public static List<Vector3> RotateVertices(List<Vector3> vertices, Quaternion rotation, Vector3 center) {
        List<Vector3> res = new List<Vector3>();
        for (var i = 0; i < vertices.Count; i++) {
